...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-purple-500">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($healthProfile->age); ?> <span class="text-sm text-gray-400 font-normal">yrs</span></p>
    </div>
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-purple-500">
        <h3 class="text-gray-500 text-sm font-medium uppercase">Height</h3>
        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($healthProfile->height); ?> <span class="text-sm text-gray-400 font-normal">cm</span></p>
    </div>
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-purple-500">
        <h3 class="text-gray-500 text-sm font-medium uppercase">Weight</h3>
        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($healthProfile->weight); ?> <span class="text-sm text-gray-400 font-normal">kg</span></p>
    </div>
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-teal-500">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($healthProfile->bmi, 1)); ?></p>
        <div class="mt-1 text-xs font-bold 
            <?php echo e($healthProfile->bmi < 18.5 ? 'text-blue-500' : 
              ($healthProfile->bmi < 25 ? 'text-green-500' : 
              ($healthProfile->bmi < 30 ? 'text-orange-500' : 'text-red-500'))); ?>">
            <?php if($healthProfile->bmi < 18.5): ?> Underweight
            <?php elseif($healthProfile->bmi < 25): ?> Normal
            <?php elseif($healthProfile->bmi < 30): ?> Overweight
            <?php else: ?> Obese
            <?php endif; ?>
        </div>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-500">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($healthProfile->blood_type); ?></p>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-pink-500">
        ...
        <p class="text-xl font-bold text-gray-900 mt-2">
            ...
            <?php if(is_array($healthProfile->allergies)): ?>
                <?php echo e(implode(', ', $healthProfile->allergies)); ?>

            <?php else: ?>
                <?php echo e($healthProfile->allergies ?? 'None'); ?>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border-l-4 border-green-500">
        ...
        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($healthProfile->status); ?></p>
    </div>
</div>
...
<div class="bg-gray-50 p-8 rounded-xl border border-gray-200 mt-12 shadow-inner">
    ...
    <div id="requestForm" class="hidden bg-white p-6 rounded-lg shadow-lg border border-gray-100">
        <form action="<?php echo e(route('requests.submit')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\xampp\htdocs\brgyhealth-main\resources\views/partials/health_profile_dashboard.blade.php ENDPATH**/ ?>