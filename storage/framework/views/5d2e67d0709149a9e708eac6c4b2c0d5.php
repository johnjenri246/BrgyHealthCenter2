...
<script>
    // Map + routing
    const barangayLat = Number(<?php echo json_encode($latitude, 15, 512) ?>);
    const barangayLng = Number(<?php echo json_encode($longitude, 15, 512) ?>);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\brgyhealth-main\resources\views/weather.blade.php ENDPATH**/ ?>